...
function loadEnhancements(){
 ['links-tools-update.js?v=20260715-151','login-screen-polish.js?v=20260715-151','personal-home-tools.js?v=20260715-152'].forEach(src=>{if(document.querySelector('script[src^="'+src.split('?')[0]+'"]'))return;const s=document.createElement('script');s.src=src;document.body.appendChild(s);});
}
function setup(){
...
function init(){style();setup();loadEnhancements();}

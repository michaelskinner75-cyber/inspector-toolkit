...
window.addEventListener('load',()=>{initInspector();$('csDate').valueAsDate=new Date();buildTimesheet();renderTicketButtons();renderAll();loadCloud();setInterval(renderAll,1000);

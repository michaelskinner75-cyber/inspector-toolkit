...
function inject(){
 try{
  ...
  add(doc,'checksheetShareReportScript','checksheet-share-report.js?v=20260722-245');
  add(doc,'savedCheckShareScript','saved-check-share.js?v=20260722-245');
  add(doc,'removeLiveReportButtonsScript','remove-live-report-buttons.js?v=20260722-245');

...
function setup(){
 ...
 if(!home||!nav||$('otherLinksTools'))return;
 ...
 const observer=new MutationObserver(()=>{
  findAdminButtons(nav).forEach(b=>{if(isMichael()){dest.appendChild(b);const page=$(b.dataset.open);const back=page?.querySelector('.backBtn[data-open="home"]');if(back)back.dataset.open='otherLinksTools';}else b.style.display='none';});
 });
